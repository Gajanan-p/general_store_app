...
public class UnitsRepository {
    ...
    public void getUnits(Integer limit, Integer offset, ApiCallback<UnitsListResponse> callback) {
        ApiExecutor.execute(
                api.getUnitsDataFromServer(limit, offset),
                callback
        );
    }
    ...
    public void addUnits(UnitsRequest request,
                         ApiCallback<GetUnitsDataModel> callback) {
