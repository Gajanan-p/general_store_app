...
public class AddProductResponse {
    ...
    public AddProductResponse(Integer id, String name, String sku, String barcode, Integer categoryId,
                              Integer unitId, Integer gstPercent, Integer costPrice, Integer sellPrice,
                              Integer mrp, Integer stockQty, Integer lowStockAlert, Integer isActive,
